...
(async () => {
  ...
  await fs.writeFile("thyroid-function-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("thyroid-function-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
